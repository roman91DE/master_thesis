...
```{bash ipythonRunner, include=FALSE}
...
The DAE-GP algorithm, first described by @dae-gp_2020_rtree, is summarized by chart 1.

![DAE-GP - Flowchart](./img/flowcharts/dae-gp.png)
