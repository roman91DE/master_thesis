...
# Values are copied from file /eda-gp-2020/experiments/airfoil_2hl_150hn_fullRun_30gens/airfoil_2hl_150hn_fullRun_30gens_TimeBenchmark.ipynb

REG_TIME <- 5076.448
PT_TIME <- 14706.465
PT_TIME_NOPT <- 12536.889

REG_MEDIAN_EPOCHSTRAINED <- 122.0
PT_MEDIAN_EPOCHSTRAINED <- 53.5

REG_MEDIAN_SAMPLINGTIME <- 29.055806166997172
PT_MEDIAN_SAMPLINGTIME <- 198.4502993219976

REG_TIME_NOSAMLING <-  3550.276852743067
PT_TIME_NOSAMPLING  <- 8705.007590330817
PT_TIME_NOSAMPLING_NOPT  <- 6622.027293765
