...
```{r airfoil-maxIndSize-fitness, echo=FALSE, fig.cap="Median Best Fitness over 30 Generations - Airfoil (2HL) with dynamic adjustment of regular DAE-GP", out.width="80%"}
...
Another disadvantage of pre-training in DAE-GP is that in order for it to show 
