...
Since pre-trained thus far did not demonstrate significant benefits for DAE-GP, this chapter introduces two alternative pre-training strategies that are also tested for the airfoil dataset:
