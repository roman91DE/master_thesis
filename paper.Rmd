...
![First Generation Median Training Error for variable number of hidden Neurons - Airfoil](./img/airfoil_firstGen/airfoil_firstGen_mean_training_error_by_neurons.png)
...
```{bash compile_airfoil_2hl_maxIndSize_fullRun_30gens, include=FALSE}
...
# add new experiments for full runs here!
# ...
```
...
/Users/rmn/miniconda3/envs/dataScience/bin/python /Users/rmn/github/master_thesis/data/summarize_finalFitness.py
```

```{r full_run_realWorldSymReg_performance, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
fig.pos="H"
knitr::kable(
  read.csv("/Users/rmn/github/master_thesis/data/summary_table_final_fit.csv", sep=","),
  caption="Performance - Real World Symbolic Regression Benchmark Problems"
)%>% row_spec(0,bold=TRUE ) %>% kableExtra::kable_styling(latex_options = "hold_position")
```



<!-- Results for Energy Cooling Dataset  -->

```{bash compile_energyCooling_2hl_maxIndSize_fullRun_30gens, include=FALSE}
bash /Users/rmn/masterThesis/eda-gp-2020/experiments/energyCooling_2hl_maxIndSize_fullRun_30gens/re_evaluate_energyCooling_2hl_maxIndSize_fullRun_30gens.sh
```
