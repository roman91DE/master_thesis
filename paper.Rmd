...
Next I studied the size of solutions based on using a pre-training strategy. Plot X shows the median size of the best solutions aggregated of all benchmark problems for symbolic regression
