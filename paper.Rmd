...
## Drawbacks of using Pre-Training

The experiments conducted in this thesis did not find any significant benefits on both solution quality as well as run-time for solving pre-training strategy for using DAE-GP to solve real world symbolic regression problems.
