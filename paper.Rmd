...
```
Table X summarizes the median best fitness achieved after running each algorithm for 30 runs using a population size of 500 individuals.^[P-Values are marked with asteriks (1,2,3) for ($\alpha$) (0.1, 0.05 and 0.01)].
