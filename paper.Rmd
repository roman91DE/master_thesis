...
```{r airfoil-maxIndSize-params, echo=FALSE, fig.cap="Median Number of trainable Parameters over 30 Generations - Airfoil (2HL)", out.width="80%"}
knitr::include_graphics("./img/airfoil_2hl_maxIndSize_fullRun_30gens/trainableParams.png")
```

As expected, this reduction of hidden neurons by dynamic adjustment, does also result in a reduction of the fitness of solutions found. Figure \@ref(fig:airfoil-maxIndSize-fitness) shows that pre-trained DAE-GP does achieve a higher median fitness than regular DAE-GP with dynmaic adjustment of hidden neurons. 


```{r airfoil-maxIndSize-fitness, echo=FALSE, fig.cap="Median Fitness over 30 Generations - Airfoil (2HL), dynamic adjustment of regular DAE-GP", out.width="80%"}
...
One major drawback of using pre-training with DAE-GP
