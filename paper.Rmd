...
REG_MED_BESTSIZE <- py$D_AIRFOIL_2hl$REG_MED_BESTSIZE
PT_MED_BESTSIZE <- py$D_AIRFOIL_2hl$PT_MED_BESTSIZE
GP_MED_BESTSIZE <- py$D_AIRFOIL_2hl$GP_MED_BESTSIZE
...
An interesting observation from studying the distribution of final fitness scores for both algorithms is that while both algorithms have a very similiar interquartile range (similar box shape), pre-trained DAE-GP has more extreme outliers for high RMSE which explains the slightly worse performance if looking at median best fitness present in figure \@ref(fig:airfoil-median-fitness-30gens). 
