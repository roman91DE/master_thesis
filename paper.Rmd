...
S = json.load(open("./data/airfoil_FullRun_30gens/MWU-BestFitnessByGen.json", "r", encoding="utf-8"))
statistic_mwu_fitness = S["statistic"]
pval_mwu_fitness = S["p-value"]
