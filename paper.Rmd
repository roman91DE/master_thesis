...
The DAE-GP algorithm, first described by @dae-gp_2020_rtree, is summarized as a flowchart in \@ref(fig:dae-gp-flowchart). 
...
```{r dae-gp-flowchart, echo=FALSE, fig.cap="Regular DAE-GP Flowchart", out.height="90%", out.width="50%"}
