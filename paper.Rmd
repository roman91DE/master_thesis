...
The DAE-GP algorithm, first described by @dae-gp_2020_rtree, is summarized as a flowchart in \@ref(fig:daegp-flowchart).
...
```{r airfoil-fullRun-2hl-maxIndSize-params, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
fig.pos="H"
knitr::kable(
