...
# Loop through all files with the .mmd extension in the current directory

for file in ./mermaid/*.mmd
do
  # Call PROG on the current file, saving the output as a .png file
  mmdc -i "$file" -o ./img/flowcharts/$(basename "$file" .mmd).png -t light -b transparent 
done
...
![DAE-GP - Algorithm](./img/flowcharts/dae-gp.png)


The pre-training strategy implemented is visualized by figure 2.

![DAE-GP - Algorithm](./img/flowcharts/pt-dae-gp.png)
...
![Airfoil - First Generation Median Training Error for variable number of hidden Layers](./img/airfoil_firstGen/airfoil_firstGen_mean_training_error_by_layers.png)

![Airfoil - First Generation final Training Error for variable number of hidden Layers](./img/airfoil_firstGen/airfoil_firstGen_boxplot_training_error_by_layer.png)
...
![Airfoil - Best Fitness over 30 Generations](./img/airfoil_FullRun_30gens/mean_median_fitness_byGens.png)
...
![Airfoil - Fitness Distribution Boxplot](./img/airfoil_FullRun_30gens/final_fit_boxplot.png)

![Airfoil - Average Population Diversity](./img/airfoil_FullRun_30gens/mean_popDiversity_byGens.png)
...
![Airfoil - Average Solution Size](./img/airfoil_FullRun_30gens/mean_Size_byGens.png)
