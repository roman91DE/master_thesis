...
### Airfoil Dataset - 2 Hidden Layers
...
knitr::include_graphics("./img/airfoil_2hl_maxIndSize_fullRun_30gens_withGP/mean_median_fitness_byGens.png")
```
...
knitr::include_graphics("./img/airfoil_2hl_maxIndSize_fullRun_30gens/final_fit_boxplot.png")
```
...
knitr::include_graphics("./img/airfoil_2hl_maxIndSize_fullRun_30gens/size_combined_median.png")
```
...
knitr::include_graphics("./img/airfoil_2hl_maxIndSize_fullRun_30gens_withGP/median_popDiversity_byGens_levOnly.png")
```


### Airfoil Dataset - 1 Hidden Layer
...
Since pre-trained thus far did not demonstrate significant benefits for DAE-GP, this chapter describes two alternative pre-training strategies that are also tested for the airfoil dataset:

## Second Generation Pre-Training
...
Figure \@ref(fig:altStrategies-Fitness) shows the median best fitness by generations for both alternative pre-training strategies as well as the results for standard DAE-GP and the standard Pre-Training implementation used in earlier exoeriments.
...
Figure \@ref(fig:altStrategies-finalFitness) 
