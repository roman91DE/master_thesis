...
```{r daegp-flowchart, echo=FALSE, fig.cap="Regular DAE-GP Flowchart", out.height="90%", out.width="50%"}
...
```{r pt-daegp-flowchart, echo=FALSE, fig.cap="Pre-Trained DAE-GP Flowchart", out.height="90%", out.width="50%"}
...
```{r airfoil-function-set, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
fig.pos="H"
knitr::kable(
...
```{r full-run-realWorldSymReg-problems, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
fig.pos="H"
knitr::kable(
