...
![First Generation Median Training Error for variable number of hidden Neurons - Airfoil](./img/airfoil_firstGen/airfoil_firstGen_median_training_error_by_neurons.png){height=800px width=200px}

![First Generation final Training Error for variable number of hidden Neurons - Airfoil](./img/airfoil_firstGen/airfoil_firstGen_boxplot_training_error_by_neurons.png){height=800px width=200px}

<!--- analyzing by layers -->

![First Generation Median Training Error for variable number of hidden Layers - Airfoil](./img/airfoil_firstGen/airfoil_firstGen_mean_training_error_by_layers.png){height=800px width=200px}

![First Generation final Training Error for variable number of hidden Layers - Airfoil](./img/airfoil_firstGen/airfoil_firstGen_boxplot_training_error_by_layer.png){height=800px width=200px}
...
![Population Diversity over 30 Generations - Airfoil](./img/airfoil_FullRun_30gens/mean_popDiversity_byGens.png){height=800px width=200px}
...
![Average Solution Size over 30 Generations - Airfoil](./img/airfoil_FullRun_30gens/mean_Size_byGens.png){height=800px width=200px}
