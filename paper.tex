...
{[}\protect\hyperlink{ref-pmlr-v5-erhan09a}{4}{]}: Pre-Training effect especially useful for lower-level layers -\textgreater{} Only adapt weights from low layers or embed the pre-trained model?
