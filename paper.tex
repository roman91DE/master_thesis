...
The resulting model is then used to sample new offspring solutions by propagating partially mutated solutions from the parent population through the DAE-LSTMS {[}\protect\hyperlink{ref-dae-gp_2020_rtree}{24}{]}.
In previous work DAE-GP has been shown to outperform GP for both a generalized version of the royal tree problem {[}\protect\hyperlink{ref-dae-gp_2020_rtree}{24}{]} as well as for a real-world symbolic regression problem {[}\protect\hyperlink{ref-dae-gp_2022_symreg}{23}{]}.
...
{\centering \includegraphics[width=0.8\linewidth]{img/symbolicRegressionSummarized/median_fitness_byGens} 
...
{\centering \includegraphics[width=0.8\linewidth]{img/symbolicRegressionSummarized/median_bestSol_size_byGens} 
...
\caption{\label{tab:full-run-realWorldSymReg-best-solution-size}Median Size of the best solution after 30 generations - Summary - Real World Symbolic Regression}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Problem
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
