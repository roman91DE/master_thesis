...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5287}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4713}}@{}}
\caption{\label{tab:airfoil-fullRun-2hl-maxIndSize-params}DAE-GP - Hyperparameter}\tabularnewline
\toprule\noalign{}
...
Training\_Mode & Convergence({[}\protect\hyperlink{ref-daegp_explore_exploit}{23}{]}) \\
Reconstruction\_Error\_Metric & Multiclass\_Cross\_Entropy \\
Learning\_Rate & 0.001 \\
Batch\_Size & 0.1 \\
Max\_Tree\_Depth & 17({[}\protect\hyperlink{ref-DEAP_JMLR2012}{6}{]}) \\
loss function & \\
Sampling\_Steps & 1 \\
Hidden\_Neurons & 150 \\
Hidden\_Layer & 2 \\
Selection\_Operator & Binary Tournament Selection \\
Corruption\_Operator & Levenshtein Edit({[}\protect\hyperlink{ref-daegp_explore_exploit}{23}{]}) \\
