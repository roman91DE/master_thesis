...
\author{}
\date{\vspace{-2.5em}Date of Submission: 2023-01-11}
...
solutions {[}\protect\hyperlink{ref-dae-gp_2020_rtree}{18}{]}.
...
parent population through the DAE-LSTMS
{[}\protect\hyperlink{ref-dae-gp_2020_rtree}{18}{]}. In previous work
DAE-GP has been shown to outperform GP for both a generalized version of
the royal tree problem
{[}\protect\hyperlink{ref-dae-gp_2020_rtree}{18}{]} as well as for a
real-world symbolic regression problem
...
\begin{figure}
\centering
\includegraphics{./img/flowcharts/dae-gp.png}
...
\includegraphics{./img/airfoil_FullRun_30gens/mean_popDiversity_byGens.png}
...
\begin{figure}
\centering
\includegraphics{./img/airfoil_FullRun_30gens/mean_Size_byGens.png}
