...
\hypertarget{airfoil-dataset---2-hidden-layers}{%
\subsubsection{Airfoil Dataset - 2 Hidden Layers}\label{airfoil-dataset---2-hidden-layers}}
...
{\centering \includegraphics[width=0.8\linewidth]{./img/airfoil_2hl_maxIndSize_fullRun_30gens_withGP/median_popDiversity_byGens_levOnly} 
