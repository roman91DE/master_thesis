...
Aufbau: Betrachtung des Suchverhalten über je $10$ Gesamtduchläufe am Airfoil Datensatz^[@machine_learning_repo] für DAE-GP und pre-trained DAE-GP
...
```
## Übersicht Trainingsepochen (Median) - Alternative Ansätze
