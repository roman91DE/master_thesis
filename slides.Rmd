...
Anwendungsgebiet: Symbolische Regression, Fokus auf Aifoil Datensatz
...
fig.pos="H"
knitr::kable(
  read.csv("./tables/airfoil_function_set", sep = ","),
...
![Airfoil Datensatz - Größe der besten Lösung über Generationen](~/masterThesis/master_thesis/img/airfoil_2hl_maxIndSize_fullRun_30gens_withGP/median_best_Size_byGens.png)
...
![Airfoil - Laufzeit](/Users/rmn/github/master_thesis/img/airfoil_2hl_maxIndSize_fullRun_30gens_TimeBenchmark/median_training_epochs.png){height=90%}

## Airfoil - Laufzeit (Sampling Time)

![Airfoil - Laufzeit](/Users/rmn/github/master_thesis/img/airfoil_2hl_maxIndSize_fullRun_30gens_TimeBenchmark/median_sampleTime.png){height=90%}
...
## Übersicht Laufzeit - Symbolische Regression
...
## Übersicht Fitness (Median) - Weitere Ansätze
...
## Auswertung Fitness (Median) - Weitere Ansätze
...
col_names <- c("Set", "DAE-GP", "2ndGen", "P-Val(1)" , "GrowInit", "P-Val(2)")
...
## Übersicht Lösungsgröße (Median) - Weitere Ansätze
...
## Auswertung Lösungsgröße (Median) - Weitere Ansätze
...
col_names <- c("DAE-GP", "2ndGen", "P-Val(1)" , "GrowInit", "P-Val(2)")
...
## Übersicht Populationsdiversität (Median) - Weitere Ansätze
...
## Auswertung Populationsdiversität (Median) - Weitere Ansätze
...
```
## Übersicht Trainingsepochen (Median) - Weitere Ansätze
...
## Auswertung Trainingsepochen (Median) - Weitere Ansätze
