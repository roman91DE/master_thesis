...
## Populationsdiversität - Symbolische Regression

\begin{tabular}{cc}
\includegraphics[width=0.45\textwidth]{~/masterThesis/master_thesis/img/energyCooling_2hl_maxIndSize_fullRun_30gens/mean_popDiversity_byGens_levOnly.png} &
\includegraphics[width=0.45\textwidth]{~/masterThesis/master_thesis/img/bostonHousing_2hl_maxIndSize_fullRun_30gens/mean_popDiversity_byGens_levOnly.png} \\
\includegraphics[width=0.45\textwidth]{~/masterThesis/master_thesis/img/airfoil_2hl_maxIndSize_fullRun_30gens/mean_popDiversity_byGens_levOnly.png} &
\includegraphics[width=0.45\textwidth]{~/masterThesis/master_thesis/img/concrete_2hl_maxIndSize_fullRun_30gens/mean_popDiversity_byGens_levOnly.png}
\end{tabular}
...
# Create the data frame from csv
df <- read.csv(
  "/Users/rmn/github/master_thesis/data/summary_table_mean_LevDistance.csv",
  sep=",",
  colClasses = c("character", "numeric", "numeric", "numeric", "character", "character")
)
